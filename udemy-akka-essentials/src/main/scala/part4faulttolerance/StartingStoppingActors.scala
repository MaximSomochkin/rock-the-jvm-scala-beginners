...
//  val child2 = system.actorSelection("/user/parent/child2") // check that child created, and take it
//  child2 ! "hi second child"
//
//  parent ! Stop
//for (_ <- 1 to 10) parent ! "parent are you still there?" //should not be recieved
...
//  abruptlyTerminatedActor ! "you have been terminated"
  ...
  val watchedChild = system.actorSelection("user/watcher/watcherChild")
  Thread.sleep(500)
