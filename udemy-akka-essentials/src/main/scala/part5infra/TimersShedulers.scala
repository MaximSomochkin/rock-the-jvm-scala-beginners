...
object TimersShedulers extends App {
  ...
  //  }/*(system.dispatcher)*/
  //
  //  val routineOld = system.scheduler.schedule(1 second, 2 seconds){
  //    simpleActor ! "reminder"
  //  }
  //
  //  val routine: Cancellable = system.scheduler
  ...
  /** Exercize: implement a self-closing actor
   *
...
//    selfClosingActor ! "pong"
  ...
  val timerBasedHeartbeatActor: ActorRef = system.actorOf(Props[TimerBasedHeartbeatActor], "timerActor")
  system.scheduler.scheduleOnce(5 seconds) {
